      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Don't have an account? <Link to="/sign-up" className="text-teal-600 font-medium hover:text-teal-700">Sign up</Link>
          </p>
        </div>
      </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-md text-center">
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-sm border border-gray-100">
                <div className="flex items-center gap-1 text-teal-500 mb-4 justify-center">
                {'★★★★★'.split('').map((s, i) => (
